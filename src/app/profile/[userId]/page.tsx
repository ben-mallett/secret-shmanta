...
export default function Profile() {
    ...
    const [userInfo, setUserInfo] = useState<{username: string, _id: string, role: string}>();
    ...
    useEffect(() => {
        const getUserData = async () => {
            try {
                const response = await axios.get("/api/users/by/id", { params: {
                    userId: userId
                }});
        ...
        const getProfileData = async () => {
            try {
                const response = await axios.get("/api/profile/by/id", { params: {
                    userId: userId
                }});
